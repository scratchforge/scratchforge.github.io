    ...
    <div style={{ padding: '20px 40px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          <div style={{ fontSize: '16px', color: '#666' }}>Total Courses Enrolled</div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '16px', color: '#666' }}>Courses Completed</div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '40px', marginBottom: '10px' }}>📈</div>
          <div style={{ fontSize: '32px', fontWeight: 'bold', color: '#7B1FA2', marginBottom: '5px' }}>
            {stats.totalProgress}%
          </div>
          <div style={{ fontSize: '16px', color: '#666' }}>Overall Progress</div>
        </div>
      </div>
